...
# Notion Database IDs - Enterprise
NOTION_FINANCE_DB_ID = os.getenv('NOTION_FINANCE_DB_ID')
NOTION_GOVERNANCE_DB_ID = os.getenv('NOTION_GOVERNANCE_DB_ID')
NOTION_OPS_MONITOR_DB_ID = os.getenv('NOTION_OPS_MONITOR_DB_ID')
NOTION_FORECAST_DB_ID = os.getenv('NOTION_FORECAST_DB_ID')
NOTION_REGION_COMPLIANCE_DB_ID = os.getenv('NOTION_REGION_COMPLIANCE_DB_ID')
NOTION_PARTNERS_DB_ID = os.getenv('NOTION_PARTNERS_DB_ID')
NOTION_REFERRALS_DB_ID = os.getenv('NOTION_REFERRALS_DB_ID')
NOTION_GROWTH_METRICS_DB_ID = os.getenv('NOTION_GROWTH_METRICS_DB_ID')
