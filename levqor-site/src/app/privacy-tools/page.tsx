        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-lg p-8">
          ...
          <div className="space-y-4 text-sm text-slate-300">
            ...
            <div>
              ...
              <p>Contact <a href="mailto:privacy@levqor.ai" className="text-emerald-400 hover:underline">privacy@levqor.ai</a> to request deletion of your account and data.</p>
            </div>
            <div>
