      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-8 mb-8 text-left">
          ...
          <div className="space-y-4 text-slate-300">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-white mb-1">We build your automation (48 hours)</h3>
                <p className="text-sm">
                  Our engineers will design, build, and test your workflows. You'll get a demo once it's ready.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-white mb-1">Go live & ongoing support</h3>
                <p className="text-sm">
                  Your automation goes live and we'll provide hands-on support based on your package (7-30 days).
                </p>
              </div>
            </div>
          </div>
        ...
        {sessionId && (
          <div className="bg-slate-900/30 border border-slate-800 rounded-lg p-4 mb-8 text-xs text-slate-400 font-mono">
            ...
            <p className="mt-1">We've sent a receipt to your email.</p>
          </div>
        )}
